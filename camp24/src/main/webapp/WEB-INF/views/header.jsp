...
<c:if test="${not empty SID}">
	<div style="width: 100%;">
		...
		<div class="w3-col m3 w3-button w3-green w3-hover-light-green" id="home"><strong>Camp 24</strong></div>
...
<header class="w3-container w3-center w3-padding-32" id="homeimage">
	<div>
...
<div class="w3-container w3-padding-32" style="max-width:2000px;">
