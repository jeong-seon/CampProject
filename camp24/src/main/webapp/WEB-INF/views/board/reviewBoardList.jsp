    ...
    <div class="container">
		...
		<c:forEach var="data" items="${LIST}">
				<div class="review-block">
					...
					<div class="row">
						...
						<c:if test="${data.score eq 5}">
							...
							<div class="review-block-title" style="margin-bottom: 0px;">캠핑장 : ${data.cname}</div>
							<div class="w3-col">
							...
							<div class="w3-col review-block-description">${data.body}</div>
			...
			<c:if test="${SID ne data.id}">
				<div class="w3-button w3-small w70 w3-green w3-right revbtn">댓글</div>
