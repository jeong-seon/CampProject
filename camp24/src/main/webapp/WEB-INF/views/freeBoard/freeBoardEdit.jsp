...
<div class="w3-container w3-center">
    <div class="form-area">  
        <form method="POST" action="/camp24/freeBoard/freeBoardEditProc.cmp" id="frm" name="frm">
        <input type="hidden" name="mno" value="${DATA.mno}">
		<input type="hidden" name="bno" value="${DATA.bno}">
		<input type="hidden" name="vw" value="${param.vw}">
		<input type="hidden" id="otitle" value="${DATA.ftitle}">
		<input type="hidden" id="obody" value="${DATA.fbody}">
        <input type="hidden" id="nowPage" name="nowPage" value="${param.nowPage}">
        <br style="clear:both">
                    <h2 style="margin-bottom: 25px; text-align: center;">자유게시판 글 수정</h2>
    				...
    				<div class="form-group">
						...
						<input type="text" class="form-control" id="title" name="title" value="${DATA.ftitle}">
					</div>
                    <div class="form-group">
                    	<div style="text-align: left;">
	    					<label for="body" style="text-align: left;"><strong>본문</strong></label>
    					</div>
                    	<textarea style="resize: none;" class="form-control" id="body" name="body"rows="7">${DATA.fbody}</textarea>
                    </div>
