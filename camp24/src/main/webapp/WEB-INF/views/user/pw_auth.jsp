...
<div id="LoginForm">
	<div class="w3-container">
		<div class="login-form">
			<div class="main-div">
			    <div class="panel">
				   <h2>Camp24 Password Authentication</h2>
			   	</div>
			    <form method="POST" action="/camp24/user/pw_set.cmp" id="frm" name="frm">
					<input type="hidden" id="num" name="num" value="${NUM}">
					<input type="hidden" id="mail" name="mail" value="${param.mail}">
			        <div class="w3-col form-group">
			
			
			            <input type="text" class="form-control" id="authNum" name="authNum" placeholder="인증번호">
			
			        </div>
			
			        <div class="forgot">
					</div>
			        <button type="submit" class="btn btn-primary w3-green" id="auth">Check</button>
