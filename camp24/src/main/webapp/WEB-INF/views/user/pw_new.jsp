...
<div id="LoginForm">
	<div class="w3-container">
		<div class="login-form">
			<div class="main-div">
			    <div class="panel">
				   <h2>Camp24 Password Update</h2>
			   	</div>
			    <form method="POST" action="/camp24/user/pw_new.cmp" id="frm" name="frm">
					<input type="hidden" id="num" name="num" value="${NUM}">
					<input type="hidden" id="mail" name="mail" value="${param.mail}">
			        <div class="w3-col form-group">
			
			
			            <input type="password" class="form-control" id="newPw" name="pw" placeholder="새 비밀번호">
			
			        </div>
			
			        <div class="w3-col form-group">
			
			            <input type="password" class="form-control" id="newPw_ch" name="newPw_ch" placeholder="새 비밀번호 확인">
			
			        </div>
			        <div class="forgot">
					</div>
			        <button type="submit" class="btn btn-primary w3-green" id="pwbtn">Update</button>
