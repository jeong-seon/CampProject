...
<head>
<meta charset="UTF-8">
<title>Camp24 QnA 게시판 글쓰기</title>
	...
	<form method="POST" action="/camp24/qnaBoard/qwriteProc.cmp" name="frm" id="frm"
		...
		<div class="w3-rest w3-padding w3-border-left">
				<div class="w3-col w3-border-gray">
					...
					<input type="text" name="title" id="title" style="resize: none;" class="w3-col w3-input w3-border w3-padding ft12">
				</div>
				<div class="w3-col w3-margin-top">
					<label for="body"><small><strong>내용</strong></small></label>
					<textarea name="body" id="body" class="w3-col w3-padding ft12 w3-border" style="resize: none; height: 100%;"></textarea>
					</div>
				</div>
