...
<div class="w3-container w3-center">
    <div class="form-area">
        ...
        <br style="clear:both">
                    <h2 style="margin-bottom: 25px; text-align: center;">Q & A 답변 작성</h2>
						...
						<span class="w3-col w3-center mgb10 ft10"><b>${SID}</b></span>
					    	<div class="w3-col w3-border-top">
								<span class="w3-col w3-left mgb10 ft10 w3-margin-top"><strong>질문 내용 : </strong> ${DATA.qbody}</span>
							</div>
                    ...
                    <div class="form-group">
                    	<div style="text-align: left;">
	    					<label for="body" style="text-align: left;"><strong>내용</strong></label>
    					</div>
